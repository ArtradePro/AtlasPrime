          ...
          <CardContent className="space-y-4">
            <div className="rounded-lg bg-primary/5 border border-primary/10 p-4">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                23 restaurants in Miami have been in business 15+ years with no
                digital presence. Consider targeted outreach.
              </p>
            </div>
            ...
            <div className="rounded-lg bg-yellow-500/5 border border-yellow-500/10 p-4">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                45 qualified leads haven't been contacted in 7+ days.
              </p>
            </div>
          </CardContent>
        </Card>
